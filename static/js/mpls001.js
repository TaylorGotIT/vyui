...
const fastip002html = `<label for="cname_input">客户名（Company Name）：</label>
...
<select id="wan1type_select" onchange="fastip002setWan1type(this.value)">
...
<option value="bridge">桥接[ Bridge ]</option></select><br><h2>FastIP单机旁挂双网模板表[fastip002]</h2><br>
...
function fastip002setWan1type(value){
    switch(value){
        case "dhcp":
            console.log(value);
            break;
