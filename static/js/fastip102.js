...
<td><select id="wan1_type_select" onchange=fastip102setWan1(this.value)>
...
<option value="CU">联通</option>
<option value="CM">移动</option></select></td>
<td><select id="wan2_type_select" onchange=fastip102setWan2(this.value)>
<option value="dhcp" selected="selected">WAN Type[ DHCP ]</option>
<option value="static">WAN Type[ Static ]</option>
<option value="pppoe">WAN Type[ PPPoE ]</option></select></td>
</tr>
...
function fastip102setWan1(value){
    let html='';
...
function fastip102setWan2(value){
    let html='';
