...
def ops_execute(ops):
    ...
    result, n11, n21 = ops.cli.execute(handle, "rule 1 permit ip vpn-instance ipsec1 source ${ce2lo} 0 destination ${pe2lo} 0")
    ...
    result, n11, n21 = ops.cli.execute(handle, "dpd retransmit-interval 30")
    result, n11, n21 = ops.cli.execute(handle, "dpd packet receive if-related enable")
    result, n11, n21 = ops.cli.execute(handle, "remote-address vpn-instance ipsec1 ${pe2pub}")
    result, n11, n21 = ops.cli.execute(handle, "rsa encryption-padding oaep")
    result, n11, n21 = ops.cli.execute(handle, "rsa signature-padding pss")
    result, n11, n21 = ops.cli.execute(handle, "undo local-id-preference certificate enable")
    result, n11, n21 = ops.cli.execute(handle, "ikev2 authentication sign-hash sha2-256")
    ...
    result, n11, n21 = ops.cli.execute(handle, "destination vpn-instance ipsec1 ${pe2lo}")
    result, n11, n21 = ops.cli.execute(handle, "quit")
    # nqa
    ...
    result, n11, n21 = ops.cli.execute(handle, "ip route-static vpn-instance ipsec1 ${pe2lo} 32 ${wan1gw} description pe2lo")
    result, n11, n21 = ops.cli.execute(handle, "ip route-static vpn-instance ipsec1 ${pe1pub} 32 ${wan1gw} description pe1pub")
    result, n11, n21 = ops.cli.execute(handle, "ip route-static vpn-instance ipsec1 ${pe2pub} 32 ${wan1gw} description pe2pub")
    ...
    result, n11, n21 = ops.cli.execute(handle, "ip route-static vpn-instance ipsec1 ${loop2ip} 30 vpn-instance ipsec2 description ipsec1-to-ipsec2")
    result, n11, n21 = ops.cli.execute(handle, "ip route-static vpn-instance ipsec2 0.0.0.0 0 vpn-instance ipsec1 ${wan1gw}")
